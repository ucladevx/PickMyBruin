...
1	pbkdf2_sha256$36000$TIguTya1YR2Q$1Qv1eQ0pf+ANE8zGcmKbgMYCbyK8XCIx9FyJvC2sbj8=	2018-02-08 04:27:33.757446+00	t	root	mark	tai	mark@marktai.com	t	t	2017-10-25 23:32:49.234+00
...
31	41	PCVMU2GZQR	t	profile_pictures/mark-tai.png	4th
...
SELECT pg_catalog.setval('oauth2_provider_accesstoken_id_seq', 103, true);
...
SELECT pg_catalog.setval('oauth2_provider_refreshtoken_id_seq', 103, true);
...
SELECT pg_catalog.setval('users_mentor_id_seq', 21, true);
...
SELECT pg_catalog.setval('users_profile_id_seq', 31, true);
