...
47	pbkdf2_sha256$36000$9KEvS2AuFaE6$rCmLYUhZhMnhWsge5u5J0IgEC4K9UBZePpPdAel9OWM=	2018-09-25 20:43:43.231499+00	t	dwchen@g.ucla.edu	David	Chen	dwchen@g.ucla.edu	t	t	2018-03-02 04:16:24+00
...
123	pbkdf2_sha256$36000$6E90HpUmtLdj$A8TkjCaSrVbah768TSGqrEZl5onSZuDFVA3tNcU0LPc=	\N	f	buzzbuzzluke@g.ucla.edu			buzzbuzzluke@g.ucla.edu	f	t	2018-05-24 04:53:50.656951+00
...
97	123	KTJ0FUYFNJ	t	profile_pictures/default_pic.jpg	Incoming		t	\N
...
53	64	EIW6TNMSGJ	t	profile_pictures/popuko.png	3rd		t	\N
...
10	16	G5DHT63DOV	t	profile_pictures/profile_8XXD3ni.JPG	2nd		t	\N
...
SELECT pg_catalog.setval('auth_user_id_seq', 151, true);
...
SELECT pg_catalog.setval('messaging_message_id_seq', 70, true);
...
SELECT pg_catalog.setval('messaging_thread_id_seq', 12, true);
...
SELECT pg_catalog.setval('oauth2_provider_accesstoken_id_seq', 359, true);
...
SELECT pg_catalog.setval('oauth2_provider_refreshtoken_id_seq', 359, true);
...
SELECT pg_catalog.setval('users_classes_id_seq', 209, true);
...
SELECT pg_catalog.setval('users_mentor_classes_id_seq', 381, true);
...
SELECT pg_catalog.setval('users_mentor_id_seq', 68, true);
...
SELECT pg_catalog.setval('users_mentor_major_id_seq', 37, true);
...
SELECT pg_catalog.setval('users_mentor_minor_id_seq', 6, true);
...
SELECT pg_catalog.setval('users_profile_id_seq', 125, true);
