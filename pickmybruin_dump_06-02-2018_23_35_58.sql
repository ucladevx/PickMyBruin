...
SELECT pg_catalog.setval('oauth2_provider_accesstoken_id_seq', 95, true);
...
SELECT pg_catalog.setval('oauth2_provider_refreshtoken_id_seq', 95, true);
...
SELECT pg_catalog.setval('users_classes_id_seq', 58, true);
...
SELECT pg_catalog.setval('users_mentor_classes_id_seq', 106, true);
...
SELECT pg_catalog.setval('users_mentor_id_seq', 19, true);
...
SELECT pg_catalog.setval('users_profile_id_seq', 29, true);
